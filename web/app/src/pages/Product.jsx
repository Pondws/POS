...
const Product = () => {
    ...
    const handleChooseMainImage = (item) => {
        Swal.fire({
            ...
            try {
                await axios.get(config.api_path + "/productImage/chooseMainImage/" + item.id + "/" + item.productId, config.headers()).then(res => {
                    if (res.data.message === "success") {
        ...
        <div>
                                ...
                                {products.length > 0 ? products.map(item =>
                                    <tr>
                                        ...
                                        <td className='text-center'>
                                            ...
                                            <button onClick={e => setProduct(item)} data-toggle="modal" data-target="#modalProduct" className='btn btn-info me-2'>
            ...
            <Modal id="modalProductImage" title="ภาพสินค้า" modalSize="modal-lg">
                <div className="row">
                    <div className="col-4">
                        <div>barcode</div>
                        <input value={product.barcode} className='form-control' disabled />
                    </div>
                    <div className="col-8">
                        <div>ชื่อสินค้า</div>
                        <input value={product.name} className='form-control' disabled />
                    </div>
                    <div className="col-12 mt-3">
                        <div>รายละเอียด</div>
                        <input value={product.detail} className='form-control' disabled />
                    </div>
                    <div className="col-12 mt-3">
                        ...
                        <div className='col-4' key={item.id}>
                            <div className='card'>
                                <img className='card-img-top'
                                    src={config.api_path + "/uploads/" + item.imageName} alt=""
                                    width="100%" />
                                <div className='card-body text-center'>
                                    ...
                                    <button className='btn btn-danger' onClick={e => handleDeleteProductImage(item)}>
                                        <i className='fa fa-times'></i>
                                    </button>
                                </div>
                            </div>
